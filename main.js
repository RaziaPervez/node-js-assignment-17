...
while (guestlist1.length > 2) {
    var removedguest1 = guestlist1.pop();
    console.log("sorry,".concat(removedguest1, ",i can't invite you at dinner"));
}
//printing a invitation to the last two guest
console.log("invitation to last two guest");
guestlist1.forEach(function (lasttwo) { return console.log("luckly ".concat(lasttwo, ",you are invited to dinner")); });
